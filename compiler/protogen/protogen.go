...
import (
	...
	"github.com/seeflood/protobuf-go/types/pluginpb"
)
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/seeflood/protobuf-go/types/known/anypb";
	//
...
// For example: "github.com/seeflood/protobuf-go/compiler/protogen"
