...
//
//	go build -ldflags "-X github.com/seeflood/protobuf-go/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/seeflood/protobuf-go/types/known/" + pkgName
	panic(fmt.Sprintf(""+
